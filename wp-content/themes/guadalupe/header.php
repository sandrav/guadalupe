    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
...
</head><body <?php body_class($class); ?>>	<?php $exclude = get_page_by_path("archivo")->ID; ?>	<div id="mainContainer">	  <div id="header">		<a class="logo" href="<?php bloginfo('siteurl'); ?>/">
		...
		<?php //include (TEMPLATEPATH . '/sidebar.php'); ?>
			...
			<ul class="socialNav">
				...
				<li class="sprite tw"><a href="https://twitter.com/mra_guadalupe" target="_blank"></a></li>
