...
<!-- TEMPLATE date -->
<div id="mainContent">
	<h2 id="novedades-title"><?php _e('Archivo','Guadalupe')." ".the_time('F Y') ?></h2>
	...
	<h2 class="sideTitle"><?php _e('Archivo','Guadalupe') ?></h2>
	<ul class="sideLink">
		<?php wp_get_archives('type=monthly&limit=12'); ?>
	</ul>
	<h2 class="sideTitle"><?php _e('Etiquetas','Guadalupe') ?></h2>
	<ul class="sideLink">
		<?php $tags = get_tags();
			if ($tags) {
				foreach ($tags as $tag) {
